...
{   
        ...
        SimReceiptPrinter receiptPrinter)
    {
        ...
        Map<Component,Component> atmPanelData = new HashMap<Component,Component>();
        atmPanelData.put(operatorPanel, operatorPanel);
        atmPanelData.put(cardReader, cardReader);
        atmPanelData.put(display, display);
        atmPanelData.put(keyboard, keyboard);
        atmPanelData.put(cashDispenser, cashDispenser);
        atmPanelData.put(envelopeAcceptor, envelopeAcceptor);
        atmPanelData.put(receiptPrinter, receiptPrinter);
       /* 
        atmPanel = new ATMPanel(this, 
                                operatorPanel, cardReader, 
                                display, keyboard,
                                cashDispenser, envelopeAcceptor, receiptPrinter);*/
        atmPanel = new ATMPanel(this, atmPanelData);
